...
Selon les services utilisés, ces prestataires peuvent notamment intervenir pour :
...
• les bases de données ;
• le stockage ;
• la synchronisation de certaines informations.
...
• Google Play ;
• Apple App Store ;
• toute autre plateforme officielle autorisée par ConteMagiqueIA.
...
• le nom ConteMagiqueIA ;
• le logo ;
• l’identité graphique ;
• l’interface ;
• les textes propriétaires ;
• le code informatique ;
• l’architecture logicielle ;
• les fonctionnalités ;
• les bases de données ;
• les éléments graphiques créés spécifiquement pour l’application.
...
Les droits applicables peuvent notamment dépendre :

• de la législation ;
• des conditions des prestataires d’intelligence artificielle ;
...
Toutefois, l’éditeur ne peut garantir :

• l’absence totale d’erreur ;
• la disponibilité permanente du service ;
• l’exactitude absolue des contenus générés automatiquement ;
...
Le signalement doit idéalement préciser :
