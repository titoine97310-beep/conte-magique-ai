...
La présente Politique relative à l’intelligence artificielle décrit les principes appliqués par ConteMagiqueIA dans l’utilisation de technologies d’intelligence artificielle pour générer des histoires, illustrations, narrations et autres contenus créatifs.


2. Finalité de l’intelligence artificielle
...
• améliorer l’expérience créative proposée aux familles.

L’intelligence artificielle constitue un outil d’assistance à la création et ne remplace pas la supervision d’un adulte lorsque l’application est utilisée par un enfant.


3. Transparence

ConteMagiqueIA informe les utilisateurs que certains contenus sont générés automatiquement à l’aide de systèmes d’intelligence artificielle.

Ces contenus peuvent notamment concerner :

• les textes des histoires ;
• les descriptions de scènes ;
• les illustrations ;
...
• des éléments qui ne correspondent pas parfaitement aux attentes de l’utilisateur.
...
Lorsqu’un enfant utilise l’application, la présence ou la supervision d’un parent ou représentant légal est recommandée.
...
• illégales ;
• sexuelles ;
• violentes de manière inappropriée ;
• haineuses ;
• discriminatoires ;
• dangereuses ;
...
Cependant, aucun système automatisé ne permet de garantir l’absence absolue de résultat indésirable.
...
• des informations permettant de localiser précisément un enfant.
...
Une même demande peut donc produire un résultat différent :
...
• du contenu fourni par l’utilisateur ;
• des conditions des fournisseurs ;
• de la nature du résultat généré.
...
• une œuvre protégée ;
• un personnage protégé ;
• une marque ;
• un logo ;
• un contenu appartenant à un tiers.
...
• automatiser massivement des générations ;
• exploiter des vulnérabilités ;
• créer un service concurrent en violation des droits applicables ;
...
• la limitation des données transmises ;
• la modération ;
• les règles de prompt ;
...
• la réduction des données sensibles transmises ;
...
• des intonations imparfaites ;
• des différences selon les langues ou appareils.
...
Les conditions relatives à l’utilisation des données par les fournisseurs dépendent des accords, paramètres et politiques applicables à chaque prestataire.
...
ConteMagiqueIA peut modifier ses pratiques et la présente politique afin de tenir compte :

• du droit français ;
• du droit européen ;
• du règlement européen sur l’intelligence artificielle lorsque applicable ;
...
• des demandes qu’il saisit ;
• des contenus qu’il décide de partager ;
