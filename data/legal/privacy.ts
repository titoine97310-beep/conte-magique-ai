...
La présente Politique de confidentialité décrit la manière dont ConteMagiqueIA collecte, utilise, protège et conserve les données personnelles des utilisateurs de l’application et de ses services associés.

ConteMagiqueIA accorde une attention particulière à la protection de la vie privée, notamment lorsque l’application est utilisée dans un cadre familial ou par des enfants sous la responsabilité de leurs parents ou représentants légaux.
...
Selon les fonctionnalités utilisées, ConteMagiqueIA peut traiter notamment les catégories de données suivantes :

• adresse e-mail ;
• identifiant technique du compte utilisateur ;
• nom ou pseudonyme renseigné dans le profil ;
• informations nécessaires à l’authentification ;
• préférences de l’application ;
• données relatives aux carnets achetés ou disponibles ;
• nombre d’histoires restantes ;
• historiques techniques liés aux achats ;
• histoires créées ou sauvegardées ;
...
• toute information permettant de localiser précisément un enfant.
...
• prévenir les abus et les utilisations frauduleuses ;
• assurer la sécurité de l’application ;
• corriger les erreurs et améliorer le fonctionnement du service ;
...
• l’exécution du contrat conclu avec l’utilisateur ;
• le consentement lorsque celui-ci est requis ;
• l’intérêt légitime de ConteMagiqueIA, notamment pour assurer la sécurité et améliorer ses services ;
...
Ces prestataires peuvent notamment inclure des services tels que Firebase / Google, OpenAI, Render, Google Play ou Apple lorsque les services correspondants sont utilisés.
...
ConteMagiqueIA n’a pas vocation à recevoir ni à conserver directement le numéro complet de la carte bancaire de l’utilisateur.
...
• droit de retirer un consentement lorsqu’un traitement repose sur celui-ci.
...
• des évolutions de ConteMagiqueIA ;
• de l’ajout de nouvelles fonctionnalités ;
• de nouveaux prestataires ;
• des évolutions réglementaires ;
• des exigences de Google Play ou de l’App Store.
